...
public class ConstantLiteral {
	...
	//信使常用常量
	public static final Integer HANLDE_SUCCESS_CODE = 100;
	public static final Integer HANLDE_FAILURE_CODE = 200;
	public static final String HANLDE_SUCCESS_STRING = "处理成功";
