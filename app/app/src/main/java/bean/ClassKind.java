...
public class ClassKind {
    ...
    public ClassKind(Integer id, Integer pId, String pName, String property, String claKName, Integer difficulty,
                           String intro) {
        super();
        this.id = id;
        this.pId = pId;
    ...
    public String toString() {
        return "ClassKind [id=" + id + ", pId=" + pId + ", pName=" + pName + ", property=" + property
