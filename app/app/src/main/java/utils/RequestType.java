...
public enum RequestType {
    ...
    Main_Photo, Main_Teacher, Main_Leave, Main_Classroom, Main_PlaceClass,

    //Mine页面基本数据信息
    Mine_OrderLessonTime, Mine_LearnTime, Mine_MemberScore,
    //Mine页面的更多功能
    Mine_OrderLesson, Mine_CommentOrder, Mine_ExperimentLessonRecord, Mine_MemberCard, Mine_BuyCard, Mine_LessonAbsent, Mine_HistoryRecord,
    //Mine页面的系统功能
